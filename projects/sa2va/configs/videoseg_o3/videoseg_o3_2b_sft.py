...
from projects.sa2va.datasets import (
    ...
    Sa2VA03RefVOS, Sa2VA04VideoQA, Sa2VA05GCGDataset, Sa2VA06VPDataset, Sa2VA07VTGDataset
)
...
sa2va_data_03_refvos_configs = [
    ...
    dict(
        ...
        expression_file=VIDEO_DATA_ROOT + 'sam_v_final_custom.json',
        repeats=2,
        dataset_type='refsav',
        **sa2va_default_dataset_configs
    ),
    dict(
        type=Sa2VA03RefVOS,
        name='Long-RVOS',
        image_folder=VIDEO_DATA_ROOT + 'Long-RVOS/train/JPEGImages',
        expression_file=VIDEO_DATA_ROOT + 'Long-RVOS/train/meta_expressions_with_anno.json',
        mask_file=VIDEO_DATA_ROOT + 'Long-RVOS/train/mask_dict.json',
        repeats=4,
        dataset_type='default',
        **sa2va_default_dataset_configs
    )
...
######################### VTG ##################################
sa2va_data_07_vtg_configs = [
    dict(
        type=Sa2VA07VTGDataset,
        name='TimeLens100K',
