...
sa2va_data_finetune_configs = [
    dict(
        ...
        expression_file="data/VTG-CoT/revos.json",
    ...
    dict(
        ...
        expression_file="data/VTG-CoT/mevis.json",
    ...
    dict(
        type=COTRefVOSv3,
        name='LongRVOS_COT',
        image_folder="data/video_datas/Long-RVOS/train/JPEGImages",
        expression_file="data/VTG-CoT/longrvos.json",
