...
from projects.sa2va.datasets import (
    ...
    Sa2VAFinetuneDataset, COTRefVOSV2
)
...
pretrained_pth = "pretrained/Sa2VA-Qwen3-VL-4B_converted.pth" # You need to change this path
...
sa2va_data_finetune_configs = [
    ...
    dict(
        type=COTRefVOSV2,
        name='GroundMoRe-COT',
        image_folder="/root/paddlejob/workspace/env_run/daiming/project/MyPub/VideoRL/DataConstruction/source_data/Sa2VA_dataset/GroundMoRe_RefVOS/train/JPEGImages",
        ...
        mask_file='/root/paddlejob/workspace/env_run/daiming/project/MyPub/VideoRL/DataConstruction/source_data/Sa2VA_dataset/GroundMoRe_RefVOS/train/mask_dict.json',
        repeats=2,
        select_number=5,
        sampled_frames=20,
        round_max_frames=3,
