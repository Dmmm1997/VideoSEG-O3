...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp_path", type=str, default="data/video_datas/ref_sav_eval/meta_expressions_valid.json")
    parser.add_argument("--mask_path", type=str, default="data/video_datas/ref_sav_eval/mask_dict.json")
    parser.add_argument("--save_name", type=str, default="ref_sav_valid.json")
    ...
    output_json_path = osp.join(osp.dirname(args.pred_path), args.save_name)
